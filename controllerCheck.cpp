...
void LinkedList::insert(string ipv6) //insert function, data is stored in add from function body
{
...
newnode->data = ipv6; //adds data to list
...
void LinkedList::remove(string ipv6) //remove function, data is stored in remove from function body
{
...
bool LinkedList::search(string searchIp)
{
Node* searchnumber = nullptr;
temp = head;
current = head;
while (current != NULL && current -> data != searchIp)
{
temp = current;
